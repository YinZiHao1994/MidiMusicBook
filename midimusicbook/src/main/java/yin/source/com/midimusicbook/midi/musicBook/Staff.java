 ...
 * SheetMusic Control. A Staff needs to draw Staff
 * 被用来在SheetMusic控制器中绘制一个单独的五线谱.一个Staff需要画五线谱
 * - The Clef 谱号
 * - The key signature 音调符号
 * - The horizontal lines 水平的线
 * - A list of MusicSymbols 音乐符号集合
 * - The left and right vertical lines 左边和右边的垂直的线
 * <p/>
 * The height of the Staff is determined by the number of pixels each
 * MusicSymbol extends above and below the staff.五线谱的高度由每个MusicSymbol高于和低于五线谱的像素数决定
 * <p/>
